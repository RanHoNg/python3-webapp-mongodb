...
from orm_mongo import User, Comment, Blog, next_id
...
def bootstrap_index():
	return{
		'__template__': 'bootstrap_index.html'
	}

@get('/')#
def index(*, page='1'):#这里的参数经过RequestHandler()解析，添加上真正存在的值，以供该方法内部直接使用。
